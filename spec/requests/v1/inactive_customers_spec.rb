...
RSpec.describe '/v1' do
    ...
    describe 'GET /v1/inactive_customers' do
      ...
      it 'returns a list of inactive customers' do
        inactive_customer1 = FactoryBot.create(:inactive_customer, inactive_urn: 123, inactive_customer_name: 'Customer One',
                                                 replacement_urn: 456, replacement_customer_name: 'Replacement One', replacement_post_code: 'AB12 3CD')
        inactive_customer2 = FactoryBot.create(:inactive_customer, inactive_urn: 789, inactive_customer_name: 'Customer Two',
        ...
        expect(json_inactive_customer).to have_attribute(:inactive_customer_name).with_value(inactive_customer1.inactive_customer_name)
        expect(json_inactive_customer).to have_attribute(:replacement_urn).with_value(inactive_customer1.replacement_urn)
        expect(json_inactive_customer).to have_attribute(:replacement_customer_name).with_value(inactive_customer1.replacement_customer_name)
        expect(json_inactive_customer).to have_attribute(:replacement_post_code).with_value(inactive_customer1.replacement_post_code)
      end
      ...
      it 'returns pagination metadata in the response' do
        15.times do |i|
          FactoryBot.create(:inactive_customer, inactive_urn: i, inactive_customer_name: "Customer #{i}",
                             replacement_urn: i + 100, replacement_customer_name: "Replacement #{i}", replacement_post_code: "AB12 #{i}CD")
        end
      ...
      it 'returns the most recent inactive customers first' do
        inactive_customer1 = FactoryBot.create(:inactive_customer, inactive_urn: 123, inactive_customer_name: 'Customer One',
                                                 replacement_urn: 456, replacement_customer_name: 'Replacement One', replacement_post_code: 'AB12 3CD', date_made_inactive: 2.days.ago)
        inactive_customer2 = FactoryBot.create(:inactive_customer, inactive_urn: 789, inactive_customer_name: 'Customer Two',
                                                 replacement_urn: 101, replacement_customer_name: 'Replacement Two', replacement_post_code: 'EF45 6GH', date_made_inactive: 1.day.ago)
